...
import { AppTheme, toPropValue } from "@/utils/styles";
...
const ScaleEffectImageContainer = styled.div<{
  ...
  overflow: hidden;
  ${({ width, theme }) => toPropValue("width", width, theme as AppTheme)}
  ${({ height, theme }) => toPropValue("height", height, theme as AppTheme)}
`;
